        ...
        {!isOpen && (
          <>
            ...
            <motion.button
              ...
              className="w-14 h-14 rounded-lg flex items-center justify-center cursor-pointer shadow-lg"
              style={{ backgroundColor: primaryColor }}
            >
              <MessageSquare className="w-6 h-6" style={{ color: textColor }} />
            </motion.button>
          </>
        )}
      </AnimatePresence>

      {/* Panel window when open */}
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="w-[360px] max-w-[calc(100vw-2rem)] h-[500px] bg-white dark:bg-gray-900 rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 shadow-xl flex flex-col"
          >
            {/* Header */}
            <div className="flex items-center justify-between px-4 py-4" style={{ backgroundColor: primaryColor, color: textColor }}>
            ...
            >
              ...
              {isLoading && chatMessages[chatMessages.length - 1]?.role === "user" && (
                ...
                >
                  <div className="bg-white dark:bg-gray-700 px-4 py-3 rounded-xl rounded-bl-sm shadow-sm">
